      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-lg">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg">
            <p className="text-sm">
              ...
              {error === 'OAuthCallback' && 'Error validating Google account'}
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-gray-500 text-center">
            Only authorized ministry officials can access this dashboard.
        ...
        <div className="pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500 text-center">
            By signing in, you agree to use this platform for transparency and
            accountability of public budget spending.
          </p>
        </div>
      </div>
    </div>
